...
const Locations = () => {
  return (
    <section className="cut-viewport overflow-hidden bg-astro bg-cover bg-top bg-no-repeat flex items-center justify-center relative">
